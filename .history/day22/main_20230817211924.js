...
const data = [
  ...
  { id: 4, name: "Category 2.1", parent: 2 },
  { id: 5, name: "Category 2.2", parent: 2 },
  { id: 6, name: "Category 2.3", parent: 2 },
  { id: 7, name: "Category 3.1", parent: 3 },
  { id: 8, name: "Category 3.2", parent: 3 },
  { id: 9, name: "Category 3.3", parent: 3 },
  { id: 10, name: "Category 2.2.1", parent: 5 },
  { id: 11, name: "Category 2.2.2", parent: 5 },
];
...
function buildTree(arr, parentId = 0) {
  ...
  for (let i = arr.length - 1; i >= 0; i--) {
    if (arr[i].parent === parentId) {
      let obj = arr[i];
      children = buildTree(arr, arr[i].parent);
      if (children.length) {
