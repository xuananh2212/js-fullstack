...
const inputAllRegister = [...document.querySelectorAll("modal-register input")];
...
if (btnLogin) {
  btnLogin.addEventListener("click", function (e) {
    ...
    inputAllRegister.forEach((input) => (input.textContent = ""));
  });
}
if (btnRegister) {
  btnRegister.addEventListener("click", function (e) {
    ...
    inputAllLogin.forEach((input) => (input.textContent = ""));
  });
}
