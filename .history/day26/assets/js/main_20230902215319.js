...
progressBar.addEventListener("mousemove", function (e) {
  console.log(e.pageX, progressBar.offsetLeft, e.offsetX);
  var timePercent =
    ((e.pageX < progressBar.offsetLeft ? 0 : e.pageX - progressBar.offsetLeft) /
      progressBar.offsetWidth) *
    100;
  var time = ((timePercent+1 >= progressBar.offsetWidth)?progressBar.offsetWidth * audio.duration) / 100;


  textValue.innerHTML = getTime(currentpercent);
