...
progressBar.addEventListener("mousemove", function (e) {
  var currentWidth =
    (e.pageX >= progressBar.offsetLeft ? progressBar.offsetLeft : e.pageX) -
    progressBar.offsetLeft;
  if (currentWidth + 1 >= progressBar.offsetWidth) {
    currentWidth = progressBar.offsetWidth;
  }
  console.log(currentWidth);
  var time =
    (((currentWidth * 100) / progressBar.offsetWidth) * audio.duration) / 100;
