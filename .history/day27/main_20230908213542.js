window.addEventListener("load", function (e) {
  ...
  function removeProduct(btnRemove) {
    // console.log(btnRemove.parentElement.parentElement.dataset.id);
    ...
    modal.addEventListener("click", (e) => {
      if (e.target.matches(".agree")) {
        console.log(orders);
        var productId = btnRemove.parentElement.parentElement.dataset.id;
        var indexProduct = orders.indexOf((orderItem) => {
          console.log(orderItem.id, productId);
          return orderItem.id === productId;
        });
        console.log(indexProduct, productId);
