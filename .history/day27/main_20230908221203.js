window.addEventListener("load", function (e) {
  ...
  modal.addEventListener("click", function (e) {
    if (e.target.matches(".agree")) {
      console.log(orders);
      console.log("vao day");
      var indexProduct = orders.findIndex((orderItem) => {
  ...
  orderData.addEventListener("click", function (e) {
    ...
    console.log(btnRemoveCurrent);
    if (btnRemoveCurrent.matches(".btn-remove-order")) {
    ...
    } else if (btnRemoveCurrent.matches("btn-removeAll-order")) {
      console.log("có vào không");
      orders = [];
      orderData.innerHTML = "Giỏ hành không có sản phẩm.";
    }
  });
