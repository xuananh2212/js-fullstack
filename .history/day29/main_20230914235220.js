...
const allSpanValues = $$(".text-value");
...
listTable.addEventListener("dragover", function (e) {
  var itemDragging = document.querySelector(".list-items.dragging");
  console.log(itemDragging);
  var listNotDragging = document.querySelector(".list-items:not(.dragging)");
