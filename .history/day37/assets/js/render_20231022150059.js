...
function handleStringRegex(content) {
  ...
  content = content.replace(
    patternYoutube,
    `<a href= "#"> 
    <iframe src="https://www.youtube.com/embed/$3" width="420" height="315" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen=""></iframe>
    </a>`
  );
  return content;
}
