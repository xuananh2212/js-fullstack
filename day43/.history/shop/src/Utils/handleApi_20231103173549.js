...
export async function getEmailApi(email, setOrders) {
     if (email) {
...
export async function handleCheckApi(setOrders) {
     let apiEmail = getApiKeyCookie();
     if (apiEmail) {
          getEmailApi(apiEmail, setOrders);
...
export async function handleAddCartAPI(productId, quantity) {
