...
const handleCheckLang = () => {
     ...
     if (!window.localStorage?.getItem('lang') || !arrayLang.includes(window.localStorage?.getItem('lang')?.toLowerCase())) {
          console.log("1");
          return 'vi'
     } else {
          return window.localStorage?.getItem('lang').toLowerCase();
     }
     // }
